...
export declare const GroupNavigationRoutes: typeof NavigationRoutes;
...
export type BottomSheetParamList = {
    ...
    Group_ChangePrivacySheet: {
        onChange: (type: string, item: any) => void;
    };
    Group_ChangePostTypeSheet: {
        onChange: (type: string, item: any) => void;
    };
    Group_ChangeCategorySheet: {
        onChange: any;
    };
